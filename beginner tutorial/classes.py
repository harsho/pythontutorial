...
Note: 'self' has no special meaning to pyton it's just convention
'''

#Class with special initial state - user __init__
...
#Instance objects
#We can add and delete attributes to our object
...
while x.counter < 10:
    ...
    #fifth loop does not start since x.counter > 10
...
in the classs, the search procceds to look in the base class.
